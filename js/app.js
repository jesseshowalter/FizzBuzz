$(document).ready(function(){
	...
	var numPrompt = function(numChoose){
		numChoose = prompt("Choose a number to play \"FizzBuzz\"");
	...
	// alert("You have chosen to play FizzBuzz up to " + userChoice + " ... Ready to get started?");	
